...
{
$upload_path="/image/info/tag/".$_POST['prodid']."/";
...
header("Location: /cms/info/magic/load_tag_image.php?loadimg=".$upload_path.$uploadfile."&num=".$_POST['numer']."");    
...
<form name="uplimg" enctype="multipinfo/form-data" action="" method="post" style="padding:0;margin:0;">
